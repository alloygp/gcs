...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    try {
      await sendWithAlert(
        { client: EMAIL_CONFIG.brand.name, formName: 'Lead form — notification', slackWebhookUrl: FORM_ALERT_SLACK_URL },
        () => resend.emails.send({
    ...
    try {
      await sendWithAlert(
        { client: EMAIL_CONFIG.brand.name, formName: 'Lead form — confirmation', slackWebhookUrl: FORM_ALERT_SLACK_URL },
        () => resend.emails.send({
